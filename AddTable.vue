<template>
  <div id="addTable">
    ...
    <div v-show="show" @click.stop class="newTable">
      <div class="typeIn">
        行:
        <input type="text" style="width:30px" v-model="row" />
        列:
        <input type="text" style="width:30px" v-model="column" />
        <button
          class="btn primary"
  ...
  methods: {
    ...
    insertTable() {
      ...
      table.parentElement.onmousedown = e => {
        ...
        this.$emit("selectRowAndColumns", str);
      };
    },
